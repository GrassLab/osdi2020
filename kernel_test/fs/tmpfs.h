...
int tmpfs_mkdir(struct dentry* parent, struct vnode** target, const char* component_name);
int tmpfs_chdir(struct dentry* parent, struct vnode** target, const char* component_name);