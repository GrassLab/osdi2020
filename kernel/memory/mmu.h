...
#define PUD_ATTR                ( PAGE_DESCRIPTOR_TABLE | PAGE_DESCRIPTOR_VALID )
#define PMD_ATTR_NORMAL         ( PAGE_DESCRIPTOR_BLOCK | PAGE_DESCRIPTOR_VALID | PAGE_DESCRIPTOR_ACCESS | ( MAIR_NORMAL_NOCACHE_IDNEX << 2 ) )
#define PMD_ATTR_DEVICE         ( PAGE_DESCRIPTOR_BLOCK | PAGE_DESCRIPTOR_VALID | PAGE_DESCRIPTOR_ACCESS | ( MAIR_DEVICE_nGnRnE_INDEX << 2 ) )
